...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnClipEmptySignature, AVDBaseWeapon*)
...
struct FGameData
{
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Game", meta = (ClampMin = "3", ClampMax = "300", Units = "s"))
